...
export const products: Product[] = [
  {
    ...
    description: 'Aquarela rosa e verde-sage com monograma em brasão e versículo bíblico',
  ...
  {
    title: 'Boho Terroso',
    description: 'Buquê terracota e creme com tipografia bold e layout moderno',
    badge: 'Convite Digital',
